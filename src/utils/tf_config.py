# -*- coding: utf-8 -*-
"""
part of config in deeplab/common
"""
...
flags.DEFINE_integer('edge_class_num',2,
                     'class number for edge segmentation')

flags.DEFINE_enum('app', 'train', ['train', 'val', 'dump'],
                  'application to run')

flags.DEFINE_enum('net_name','deeplab_edge',['deeplab_edge','deeplab_base','deeplab_global'],
