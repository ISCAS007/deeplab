...
tf.app.flags.DEFINE_string(
    'train_dir', os.path.expanduser('~/tmp/logs/tensorflow'),
...
#    time_str = time.strftime("%Y-%m-%d___%H-%M-%S", time.localtime())
    FLAGS.train_dir=os.path.join(FLAGS.train_dir,'lenet',FLAGS.dataset_name,FLAGS.note)
    ...
    with tf.Graph().as_default():
        ...
        with tf.device(deploy_config.inputs_device()):
            ...
            print(image.shape, label.shape, '*'*30)
